...
![Version: 0.37.1](https://img.shields.io/badge/Version-0.37.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: nightly](https://img.shields.io/badge/AppVersion-4.26.0--nightly-informational?style=flat-square)
...
| global.seleniumGrid.imageTag | string | `"nightly"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"nightly"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"nightly"` | Image tag for browser's video recorder |
